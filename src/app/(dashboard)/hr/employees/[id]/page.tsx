          ...
          <AnimatePresence mode="wait">
            {activeTab === 'Personal Details' && (
              <motion.div key="p-details" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
                <h3 className="text-sm font-semibold uppercase tracking-widest" style={{ color: 'var(--color-heading)', marginBottom: 16 }}>Personal Identity</h3>
                <div className="grid grid-cols-2 gap-y-6">
                  ...
                  <div className="col-span-2 mt-2">
                    <p className="text-xs font-bold uppercase tracking-widest" style={{ color: 'var(--color-heading)', marginBottom: 12 }}>Emergency Contact</p>
            ...
            {activeTab === 'Work Details' && (
              <motion.div key="w-details" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
                <h3 className="text-sm font-semibold uppercase tracking-widest" style={{ color: 'var(--color-heading)', marginBottom: 16 }}>Work Assignment</h3>
                <div className="grid grid-cols-2 gap-y-6">
            ...
            {activeTab === 'Leave Log' && (
              <motion.div key="l-log" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-6">
                ...
                <div>
                  <h3 className="text-sm font-semibold uppercase tracking-widest" style={{ color: 'var(--color-heading)', marginBottom: 12 }}>Leave History</h3>
                  {leaves.length === 0 ? (
            ...
            {activeTab === 'Update Details' && (
              <motion.div key="u-details" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="max-w-xl">
                ...
                <div className="mb-6 pt-5 border-t border-slate-100">
                  <h3 className="text-sm font-semibold uppercase tracking-widest" style={{ color: 'var(--color-heading)', marginBottom: 16 }}>LMS Notification Channel</h3>
                ...
                {/* Employment Status */}
                <div className="mb-6 pt-5 border-t border-slate-100">
                  <h3 className="text-sm font-semibold uppercase tracking-widest" style={{ color: 'var(--color-heading)', marginBottom: 16 }}>Employment Status</h3>
                  <select
