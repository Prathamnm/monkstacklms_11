...
export default function ManagerApplyLeavePage() {
  ...
  const applyMutation = useMutation({
    mutationFn: async () => {
      ...
      const title = reason.trim().slice(0, 100) || 'Leave request'
      const res = await fetch('/api/manager/apply-leave', {
        method: 'POST',
        headers: {
    ...
    onSuccess: () => {
      toast.success('Leave recorded and auto-approved.')
      queryClient.invalidateQueries({ queryKey: ['leaveBalance'] })
      queryClient.invalidateQueries({ queryKey: ['myLeaves'] })
      router.push('/manager/my-leaves')
    },
    onError: (err: Error) => {
  ...
  return (
    <div className="p-6 lg:p-8">
      <PageHeader
        ...
        description="Select dates — your request is approved automatically as a manager"
      />
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          >
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 flex gap-2 text-blue-800 text-sm">
              ...
              <p>As a manager, your leave is automatically approved.</p>
            </div>
